...
process_jsonl_file("./training_dataset_jsonl")

# Load training dataset
train_dataset = load_dataset("json", data_files="./training_dataset_jsonl", split="train")
...
model.eval()
with torch.no_grad():
    generated_code = tokenizer.decocde(model.generate(**model_input, max_new_tokens=256, pad_token_id=2)[0], skip_special_tokens=True)
